...
export function HeroSection({ onNextClick }) {
    ...
    const bookingReq = {
      ...
      try{
        ...
        if (response.ok) {
          ...
          console.log("response data", data.data); // This will print the data property of the response
        }
      }catch(error){
  ...
  const savePayment = async (bookingId, customerId, vehicleId, amount, paymentDate, paymentTime) => {
